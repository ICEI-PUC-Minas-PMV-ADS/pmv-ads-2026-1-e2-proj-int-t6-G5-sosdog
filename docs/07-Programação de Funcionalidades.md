...
| RF-004 | Permitir que o criador da ocorrência edite ou exclua seu próprio registro. | `OcorrenciasController.cs` (Edit, Delete), `Views/Ocorrencias/_EditarOcorrenciaModal.cshtml` | Vitor |
